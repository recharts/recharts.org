export default {
  SimpleLineChart: '//jsfiddle.net/0gtjy8eg/embedded/result,js,css,html,resources/',
  TinyLineChart: '//jsfiddle.net/mjz1xnf9/embedded/result,js,css,html,resources/',
  ...
  TinyAreaChart: '//jsfiddle.net/s9m76eny/embedded/result,js,css,html,resources/',

  TinyBarChart: '//jsfiddle.net/e7qb3b5b/embedded/result,js,css,html,resources/',
  SimpleBarChart: '//jsfiddle.net/zat7zufw/embedded/result,js,css,html,resources/',
  StackedBarChart: '//jsfiddle.net/s9vnrvj2/embedded/result,js,css,html,resources/',
  MixBarChart: '//jsfiddle.net/o6j39n2d/embedded/result,js,css,html,resources/',
  CustomShapeBarChart: '//jsfiddle.net/63543koy/embedded/result,js,css,html,resources/',
  PositiveAndNegativeBarChart: '//jsfiddle.net/m0wfg72p/embedded/result,js,css,html,resources/',
  BrushBarChart: '//jsfiddle.net/mxug6e7k/embedded/result,js,css,html,resources/',
  ...
  JointLineScatterChart: '//jsfiddle.net/e7z9Los0/embedded/result,js,css,html,resources/',

  TwoSimplePieChart: '//jsfiddle.net/289dz4cf/embedded/result,js,css,html,resources/',
  ...
  AreaResponsiveContainer: '//jsfiddle.net/1sy4pvnm/embedded/result,js,css,html,resources/',
  ComposedResponsiveContainer: '//jsfiddle.net/k38xve4g/embedded/result,js,css,html,resources/',
  PieResponsiveContainer: '//jsfiddle.net/yuz5cfsv/embedded/result,js,css,html,resources/',
};
