  ...
  props: [
    {
      ...
      isOptional: false,
      desc: {
        'en-US': 'If set 0, all the ticks will be showed. If set preserveStart", "preserveEnd" or "preserveStartEnd", the ticks which is to be showed or hided will be calculated autoly.',
      ...
      isOptional: true,
      desc: {
        'en-US': 'If set false, no ticks will be drawn. If set a object, the option is the configuration of ticks. If set a React element, the option is the custom react element of drawing ticks. If set a function, the function will be called to render customized tick.',
