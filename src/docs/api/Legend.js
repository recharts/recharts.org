export default {
  name: 'Legend',
  desc: {
    'en-US': 'By default, the content of the legend is generated by the name of the Line, Bar, Area, etc. Alternatively, if no name has been set, the dataKey will be used to generate the legend content.',
