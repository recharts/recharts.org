export default {
  name: 'Legend',
  desc: {
    'en-US': `By default, the content of legend is generated by the name of Line, Bar, Area, etc.
    When no name has been setted, dataKey will be used to generate legend content alternatively.`,
