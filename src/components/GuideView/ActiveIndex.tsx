  ...
  return (
    <article>
      ...
      <p>
        ...
        <ul>
          <li>
            <code>defaultIndex</code>: Sets the initial index of the item that is highlighted when the chart is
            rendered, before any user interactions
          </li>
          <li>
          ...
          <li>
            <code>cursor</code>: Is what renders in the plot area, to draw attention to the item that is being
            interacted with. You can turn it off by passing <code>cursor={false}</code>.
          </li>
        </ul>
      </p>
