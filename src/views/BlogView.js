    ...
    <div className="page page-blog">
      ...
      <div className="blog">
        ...
        <p className="abstract">
          ...
          To help you get started and easily add beautiful data visualization to your favorite application,
          here are some of the best Javascript data visualization libraries around in 2018 (unranked). Feel free to comment and add your own suggestions and insights!
        </p>
      </div>
      <div className="blog">
        <p className="title">
